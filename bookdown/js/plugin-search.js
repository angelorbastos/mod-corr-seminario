gitbook.require(["gitbook", "lodash", "jQuery"], function(gitbook, _, $) {
    ...
    function createForm(value) {
        ...
        $searchInput = $('<input>', {
            ...
            'class': 'form-control',
            'val': value,
            'placeholder': 'Escreva sua pesquisa (use Enter para navegar)',
            'title': 'Use as setas para cima, para baixo ou Enter para navegar entre os resultados da pesquisa.'
        });

        $searchLabel.append("Digite para realizar a busca");
